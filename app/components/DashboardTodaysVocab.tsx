...
function DashboardTodaysVocab({ words, isModalOpen, onCloseModal }: DashboardTodaysVocabProps) {
          ...
          {words.map((item, index) => (
            <div key={index} className="border-b border-gray-100 last:border-0 pb-6 last:pb-0">
              <div className="flex items-start justify-between mb-2">
                ...
                <span className="px-2 py-1 text-xs font-medium text-red-600 bg-red-100 rounded-full">pending</span>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="px-6 py-4 border-b flex items-center justify-between bg-gray-50">
              ...
              <button onClick={onCloseModal} className="text-gray-400 hover:text-gray-600 cursor-pointer">
                Close
              </button>
            </div>
