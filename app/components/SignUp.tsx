  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        {/* Email Input */}
        <div className="mb-4">
          <label htmlFor="email-signup" className="block text-sm font-semibold text-gray-800 mb-1.5">
            Email
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        {/* Password Input */}
        <div className="mb-6">
          <label htmlFor="password-signup" className="block text-sm font-semibold text-gray-800 mb-1.5">
            Password
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
